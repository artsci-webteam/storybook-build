import{_ as z,B}from"./Button-fecba61c.js";import"./vue.esm-bundler-317b944f.js";import"./utlity-04b79d70.js";const S={title:"Components/Button",parameters:{docs:{source:{code:null}}},component:z,tags:["autodocs"],argTypes:{url:{control:{type:"text"}},color:{control:{type:"select"},options:["primary","secondary","tertiary"]},size:{control:{type:"select"},options:["small","medium","large"]},...B.argTypes,full:{name:"full width",control:{type:"boolean"}},transparent:{name:"transparent",control:{type:"boolean"}},light_font:{control:{type:"boolean"}},icon:{control:{type:"text"}}}},s=T=>({components:{ResearchButton:z},setup(){return{args:T}},template:`
    <research-button
      :url="args.url"
      :color="args.color"
      :size="args.size"
