import{_ as z,B}from"./Button-CZ76V5-o.js";import"./vue.esm-bundler-DMt0-Ms5.js";import"./utlity-DqUowty0.js";const S={title:"Components/Button",parameters:{docs:{source:{code:null}}},component:z,tags:["autodocs"],argTypes:{url:{control:{type:"text"}},color:{control:{type:"select"},options:["primary","secondary","tertiary"]},size:{control:{type:"select"},options:["small","medium","large"]},...B.argTypes,full:{name:"full width",control:{type:"boolean"}},transparent:{name:"transparent",control:{type:"boolean"}},light_font:{control:{type:"boolean"}},icon:{control:{type:"text"}}}},s=T=>({components:{ResearchButton:z},setup(){return{args:T}},template:`
    <research-button
      :url="args.url"
      :color="args.color"
      :size="args.size"
